...
export default function TeacherDashboard() {
  ...
  return (
    <div className="page">
      ...
      {/* ACTIVE BROADCAST CARD (OR START SESSION FORM) */}
      {activeSession ? (
        <div className="card">
          ...
          {hudMode === 'token' ? (
            <div className="token-display">
              <div className="text-sm text-dim">Share this PIN with students</div>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <div className="flex gap-1">
              ...
              <button
                className="btn btn-outline btn-sm"
                onClick={() => fetchRoster(activeSession.id)}
              >
                🔄
              </button>
            </div>
            ...
            <>
              ...
              <div className="roster-list">
                ...
                {filteredRoster.length === 0 && (
                  <p className="text-dim text-sm text-center py-4">No matching students</p>
                )}
              </div>
            </>
          )}
